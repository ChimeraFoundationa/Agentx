...
"""
    ...
    # =========================================================================
    # a2a command (Agent-to-Agent)
    # =========================================================================
    def cmd_a2a(args):
        """Execute A2A CLI command"""
        from hermes_cli.a2a_cli import a2a
        # Pass remaining args to a2a group
        sys.argv = [sys.argv[0]] + args.a2a_args
        a2a()

    a2a_parser = subparsers.add_parser(
        "a2a",
        help="Agent-to-Agent (A2A) commands",
        description="Manage agent-to-agent interactions"
    )
    a2a_parser.add_argument('a2a_args', nargs='*', help='A2A subcommand and arguments')
